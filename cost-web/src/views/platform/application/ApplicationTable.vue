...
<template>
  <div ref="applicationTable">
    <el-table :data="tableData" stripe border style="width: 100%">
      ...
      <el-table-column  :label="this.$l('lbl_application_type')" width="100">
        <template slot-scope="scope" >
          <fd-label :code="scope.row.type" type="pf_application_type" ></fd-label>
        </template>
      </el-table-column>

      <el-table-column prop="routePath" :label="this.$l('lbl_application_route_path')" width="150"></el-table-column>
