            ...
            <div style="margin-top:-30px">
                <mt-searchform>
                    ...
                    <template slot="form">
                         ...
                         <ProjectSelector v-if="!accountingObje"
                ...
                <div ref="targetCostCompilationTable">
                    <el-table :data="tableDataList"
                        ...
                        <el-table-column prop="accountingObjName" width="250"
                                         label="成本分期">

                        </el-table-column>

                        <el-table-column prop="cpName" width="150"
                                         label="合约规划名称">
                        </el-table-column>
...
import { getFirstCategory, getSecondCategory } from '@/api/cost/SelectContractPlanAPI'
...
export default {
  ...
  methods: {
    ...
    onSearch() {
      ...
      getTargetCostContractPlan({ 'accountingObjectId': this.p_queryModel.accObjId, 'level1Id': this.form.oneLevel, 'level2Id': this.form.twoLevel, 'cpName': this.form.contractPlan }).then(response => {
    ...
    getUserInfo() {
      LoadingUtil.showLoading()
      // alert(this.p_queryModel.accObjId)
      getTargetCostContractPlan({ 'accountingObjectId': this.p_queryModel.accObjId })
        .then(response => {
          LoadingUtil.hideLoading()
          this.isShow = true
          let accountObject = response.data ? response.data : []
