            ...
            <template>
                <el-tabs v-model="activeName2"
                            ...
                            <el-row>
                                ...
                                <el-col :span="8">
                                    ...
                                    <el-form-item :label="'造价确认金额(元)：'"
                                                  prop="costConfirmAmt">
                                        <amount-input  v-model='designAlterationModel.costConfirmAmt':disabled="needDisable"/>
                                    </el-form-item>
                                </el-col>
                            ...
                            <el-row>
                                <el-col :span="8">
                                    ...
                                    <el-form-item :label="'经办人：'">
                                        <el-input v-model='designAlterationModel.costConfirmOperator'
                                                  :disabled="true"></el-input>
                                    </el-form-item>
                                </el-col>
                                ...
                                <el-col :span="8">
                                    ...
                                    <el-form-item :label="'提交日期：'">
                                        <el-date-picker v-model='designAlterationModel.costConfirmDate'
                                                        :disabled="true"
                                                        type="date">
                                        </el-date-picker>
                                    </el-form-item>
                            ...
                            <el-row v-if="isShowAudit">
                                ...
                                <el-col :span="8">
                                    ...
                                    <el-form-item label="审批状态："
                                      ...
                                      prop="name">
                                      <fd-label
                                        :code="designAlterationModel.approveStatus"
                                        :class="{col:flag}"
                                        :url= "bpmUrl"
                    ...
                    <el-tab-pane label="成本拆分"
                       ...
                       <!-- <CostSplittingTable v-model="designAlterationModel.designAlterationContractList[0].contractModel.splittingModels_cp2sb2ct"
                                     :splittingWay="designAlterationModel.designAlterationContractList[0].contractModel.splittingWay"
                                     @saveSplit="saveSplit"
                                        ></CostSplittingTable> -->
...
<script >
import ChangeFormatAlocation from '@/views/cost/designAlteration/ChangeFormatAlocation'
import { LoadingUtil } from '@/utils/common/LoadingUtil'
import { ptn } from '@/utils/common/validate'
import { costConfirmDesignAlterationInstruction, getDesignAlterationInstructionDetail, getDesignAlterationDetail, submitCost, submitCostRetry, dynacostSplittingList } from '@/api/cost/designAlteration'
      ...
      getDesignAlterationInstructionDetail({ id: this.$route.query.id, processNode: '4' })
        .then(response => {
          ...
          if (this.$route.query.isView) {
            ...
            this.designAlterationModel.costConfirmOperator = this.$getUserInfo()['nickName']
            this.designAlterationModel.costConfirmDate = new Date()
          }
