...
<template>
  <div ref="FundsMonthTable">
    ...
    >
      ...
      <!-- 资金计划月份 -->
      <el-table-column prop="fundsMonth" show-overflow-tooltip :label="'资金计划月份'"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    settingTableHeight: function () {
      const topHeight = this.$refs['FundsMonthTable'].getBoundingClientRect().top
      this.tableHeight = this.fullHeight - topHeight - 80
      this.$refs['FundsMonthTable'].style.Height = this.tableHeight + 'px'
    },
    // 提示信息
