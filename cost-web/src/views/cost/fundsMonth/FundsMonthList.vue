...
<template>
    <div class='app-container'>
                                ...
                                <el-col :span="6">
                                    <el-form-item :label="'资金计划月：'">
                                        <el-select v-model='queryModel.fundsYear'
                                                   placeholder="请选择"
                                                   :clearable="true">
                                            <el-option v-for="item in selectData.fundsMonthList"
                                                       :key="item.value"
                                                       :label="item.label"
                                                       :value="item.value">
                                            </el-option>
        ...
        <FundsMonthTable :queryObj_passed_in='queryModel'
                         ref='NewOrUpdateFundsMonth'></FundsMonthTable>
    </div>
</template>
...
import FundsMonthTable from '@/views/cost/fundsMonth/FundsMonthTable'
...
export default {
    data () {
        return {
            ...
            selectData: {
                fundsMonthList: [{ label: '2018-01', value: '2018-01' }, { label: '2018-2', value: '2018-2' }]
            }
        }
    },
    components: {
    ...
    methods: {
        add () {
            this.$router.push({
                ...
                query: { id: 0, isEdit: true, isAdd:true }
            })
        },
        initVM () {
        ...
        search () {
            this.$refs.NewOrUpdateFundsMonth.getList()
        }
    },
    watch: {
        p_queryModel: {
