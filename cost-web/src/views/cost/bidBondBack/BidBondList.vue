    ...
    <div class='app-container'>
      <mt-searchform>
        <template slot="buttons">
          <el-button icon='el-icon-plus'  v-if="$checkPersmissionByCode('cost:paymentCashDeposit:createOrUpdate')"
                    type='primary'
                    @click='add' size="mini">{{$l("btn_add")}}</el-button>
        </template>
        <template slot="form">
          <el-row>
            <el-col :span="6">
            ...
            <el-col :span="6"  class="search-btn" style="float:right">
              <el-form-item>
      ...
      <BidBondTable :queryObj_passed_in='queryModel'
                          ref="BidBondTable"></BidBondTable>
    </div>
</template>
...
import BidBondTable from '@/views/cost/bidBondBack/BidBondTable'
