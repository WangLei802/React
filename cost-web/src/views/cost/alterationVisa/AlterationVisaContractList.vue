  ...
  <div class='app-container'>
    ...
    <mt-searchform>
      ...
      <template slot="form">
        ...
        <AlterationVisaContractTable :queryObj_passed_in='queryModel' :projectModel="projectModel"
                               ref='AlterationVisaContractTable'></AlterationVisaContractTable>
...
<script>
  ...
  import AlterationVisaContractTable from '@/views/cost/alterationVisa/AlterationVisaContractTable'
  ...
  export default {
    ...
    methods: {
      ...
      search(tab) {
        // this.initVM()
        this.$refs.AlterationVisaContractTable.getList()
      },
      handleExport() {
        COSTBUSINESS.download(process.env.COST_API + '/designAlteration/exportDesignAlterationContractData?' +
