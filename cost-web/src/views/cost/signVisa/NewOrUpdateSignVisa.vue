<template>
    <div class='app-container'>
        ...
        <el-form label-width='150px'
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item :label="'施工单位上报日期：'">
                <el-date-picker v-model='designAlterationModel.reportDate'
                                type="date">
                </el-date-picker>
              </el-form-item>
            </el-col>
                    ...
                    <template slot-scope="scope">
                        ...
                        <el-form-item v-show="isEdit"
                            ...
                            <fd-select v-model='scope.row.isHasIneffective'
                                       ...
                                       @change="(v) => {changeEffect(v, scope.row)}"></fd-select>
                        </el-form-item>
                    </template>
                </el-table-column>
      ...
      <span style="float: left">
        <CostFileUpload
          ...
          v-model="fileList" :limit="limit" :size="size" :attachmentData="attachmentData" :outerId="outerId">
            ...
            <!--<el-input v-model='contractQueryModel.contractName' style="width: 200px"></el-input>-->

            <!--<el-button type='primary' style="float: right" @click="queryContract">{{$l("btn_search")}}</el-button>-->
            <!--</el-form-item>-->

            <!--</el-form>-->
            <!--<el-table :data="selectTable" row-key="id" @selection-change="handleSelectionChange">-->
            <!--<el-table-column type="selection" align="center" width="55"></el-table-column>-->
            <!--<el-table-column property="contractNumber" label="合同编号" width="100"></el-table-column>-->
            <!--<el-table-column property="contractName" label="合同名称" width="100"></el-table-column>-->
            <!--<el-table-column property="contractType" label="合同类型" width="200"></el-table-column>-->
            <!--<el-table-column property="isPrimary" label="合同性质"></el-table-column>-->
            <!--<el-table-column property="contractStatus" label="状态"></el-table-column>-->
            <!--</el-table>-->
            <!--<div class='pagination_bar'>-->
            <!--<mt-pagination @size-change='handleSizeChange' @current-change='handleCurrentChange' :current-page.sync='contractQueryModel.pageNum' :page-sizes='[10, 20, 30, 40]' :page-size='contractQueryModel.pageSize' layout='sizes, prev, pager, next' :total='contractQueryModel.count'>-->
            <!--</mt-pagination>-->
            <!--</div>-->

            <!--<el-button type="primary" @click='confirmContract'>确认</el-button>-->
...
import { dynacostSplittingList } from '@/api/cost/designAlteration'
import { getDesignAlterationDetail, getContractList, createDesignAlterationDetail, getByAlterationId, getCode, submit } from '@/api/cost/signVisa'
...
export default {
  ...
  data() {
    ...
    return {
      ...
      editableTabsValue2: '',
      tabIndex: 0,
      moduleCode: COSTENUM.module.SIGN_VISA,
      editableTabs2: [],
      instructShows: [],
      completionShows: [],
      costShows: [],
      ...
      rules: {
        ...
        name: [
          { required: true, message: '请输入现场签证名称', trigger: 'blur' }
        ],
        reasonTypeCode: [
          { required: true, message: '请选择现场签证原因', trigger: 'change' }
        ],
        specialityType: [
  ...
  methods: {
    ...
    getSplittingList() {
      ...
      dynacostSplittingList({ moduleType: '3_1', designAlterationContractList: this.designAlterationModel.contractTableData, moduleDataPK: this.designAlterationModel.moduleDataPK }).then(response => {
      ...
      if (this.$route.query.isAdd) {
        ...
        getDesignAlterationDetail({ id: this.$route.query.id })
          .then(response => {
            ...
            this.designAlterationModel.reportDate = response.data.reportDate
