<template>
  <div class='app-container'>
    ...
    <PaymentContractPlatformAccountTable :queryObj_passed_in="queryModel" ref="paymentContractPlatformAccountTable"></PaymentContractPlatformAccountTable>
  </div>
</template>

<script>
  import ProjectSelector from '@/components/cost/ProjectSelector/'
  import PaymentContractPlatformAccountTable from '@/views/cost/payment/applyPaymentContract/PaymentContractPlatformAccountTable'
  ...
  export default {
    ...
    components: {
      ProjectSelector,
      PaymentContractPlatformAccountTable
    },
    methods: {
      handleExport() {
        COSTBUSINESS.download(process.env.COST_API + '/applyPaymentContract/exportPaymentContractPlatformAccountTable?' +
      ...
      search() {
        ...
        this.$refs.paymentContractPlatformAccountTable.search()
      },
      reset() {
