<template>
     <div>
        <el-radio-group v-model="splitting" :disabled="buttonDisable">
        ...
        <el-table :data="form.retailAmountAdjustmentList"  
                    ...
                    <el-table-column prop="amount"
                        ...
                        <template slot-scope="scope">
                         ...
                         <span v-if="splitting && splitting=== '1'"> <input style="width:80%" v-model="scope.row.amount" :disabled="buttonDisable"></span>
