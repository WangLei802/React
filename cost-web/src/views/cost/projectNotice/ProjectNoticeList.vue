    ...
    <div class='app-container'>
      ...
      <mt-searchform>
        <template slot="buttons">
          <el-button icon='el-icon-plus' size="mini" v-if="$checkPersmissionByCode('cost:paymentEngineering:create')"
                      type='primary'
        ...
        <ProjectNoticeTable :queryObj_passed_in='queryModel'
                          ref="ProjectNoticeTable"></ProjectNoticeTable>
    </div>
</template>
...
import ProjectNoticeTable from '@/views/cost/projectNotice/ProjectNoticeTable'
...
export default {
  ...
  methods: {
    ...
    reset() {
      ...
      this.$refs.ProjectNoticeTable.getList()
    },
    search() {
      this.$refs.ProjectNoticeTable.getList()
    }
