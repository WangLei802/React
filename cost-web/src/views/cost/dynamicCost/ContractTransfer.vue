    ...
    <div class='app-container'>
        <div style="text-align:right; margin:10px 0;border-bottom:1px solid #ccc;padding-bottom: 10px;">
            <span class="breadcrumb-child"
                  style="float: left;margin-top: 7px;"> 合同转固</span>
            <el-button size="mini"
            ...
            <el-row :gutter="12">
                <el-col :span="8">
                    ...
                    <el-form-item :label="'项目名称:'"
                                  prop="projectName">
                        <el-input v-model="form.budgetConveySure.projectName"
                                  :disabled="true">
                ...
                <el-col :span="8">
                    ...
                    <el-form-item :label="'合同编号:'">
                        <el-input v-model="form.budgetConveySure.contractNumber"
                ...
                <el-col :span="8">
                    ...
                    <el-form-item :label="'合同名称:'"
                                  prop="contractName">
                        <el-input v-model='form.budgetConveySure.contractName'
                                  :disabled="true"></el-input>
                    </el-form-item>
                </el-col>
            ...
            <el-row :gutter="12">
                <el-col :span="8">
                    ...
                    <el-form-item :label="'合同金额(元):'"
                                  prop="contractValue">
                        <el-input v-model="form.budgetConveySure.contractValue"
                                  :disabled="true">
                ...
                <el-col :span="8">
                    ...
                    <el-form-item :label="'转固金额(元):'">
                        <el-input v-model="form.budgetConveySure.conveySureMoney"
                                  :disabled="true"></el-input>
                    </el-form-item>
                </el-col>
                ...
                <el-col :span="8">
                    <el-form-item :label="'拆分状态:'">
                        <el-input v-model='form.budgetConveySure.splitStatus'
                                  :disabled="true"></el-input>
                    </el-form-item>
                </el-col>
    ...
    init() {
      if (this.$route.query.moduleType) {
        ...
        getSplittingAdjust({ 'moduleType': this.$route.query.moduleType, 'moduleDataPK': this.$route.query.moduleDataPk }).then(response => {
          ...
          this.form.budgetConveySure = response.data.budgetConveySure
          this.form.budgetConveySure.splitStatus = '合同转固'
