...
export default {
    name: 'AccountingTargetTreeSelector',
    props: {
        value: {
            type: Object
        },
    ...
    methods: {
        ...
        getThemeColor (theme) {
            ...
            //let theme = this.$store.state.themecolor //getLocalItem(Constants.Theme_Color)
            if (theme) {
                theme = '#' + theme
        ...
        handleNodeClick (data) {
            ...
            if (data.type === COSTENUM.projectTreeType.TREE_NODE_ACC_OBJ) {
                ...
                this.rebuildDepartTree(data)// 核算对象变化
            }
            this.handleTreeNodeClick(data)
        },
        // 核算对象变化重新构建部门(COSTENUM.projectTreeType.TREE_NODE_DEPT)树
